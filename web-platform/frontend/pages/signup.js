        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Start your journey to becoming a profitable trader
            </p>
          </div>
            ...
            <div className="mb-6 space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Browse all traders and free content</p>
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-green-500 mr-3 mt-1">✓</span>
                <div>
                  ...
                  <p className="text-sm text-gray-600">Subscribe to expert traders</p>
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-green-500 mr-3 mt-1">✓</span>
                <div>
                  ...
                  <p className="text-sm text-gray-600">Use price checkers and calculators</p>
                </div>
              </div>
            </div>
