...
export async function startBot() {
  ...
  client.on(Events.MessageCreate,async message=>{await handleMessage(message);await onMemberActivity(message).catch(console.error);await onEconomyMessage(message).catch(console.error);});
